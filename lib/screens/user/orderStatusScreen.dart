...
class _OrderStatusScreenState extends State<OrderStatusScreen> {
  List<String> ordersRestaurant = [];
  List<String> ordersSkooper = [];
  // getOrderList() async {
  //   SharedPreferences sp = await SharedPreferences.getInstance();
  //   ordersRestaurant = sp.getStringList('ordersListRestaurant')!;
  //   print('ordersRestaurant sp');
  //   print(ordersRestaurant);
  //   print('is give rating');
  //   print(ordersRestaurant.contains(widget.order['_id']));
  //   ordersSkooper = sp.getStringList('ordersListRestaurant')!;
  // }
  Future<Map<String, List<String>>> getOrderList() async {
    SharedPreferences sp = await SharedPreferences.getInstance();
    ordersRestaurant = sp.getStringList('ordersListRestaurant') ?? [];
    ordersSkooper = sp.getStringList('ordersListSkooper') ?? [];
                    ...
                    FutureBuilder<Map<String, List<String>>>(
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.connectionState ==
                          ...
                          // Data loaded successfully, you can access it using snapshot.data
                          List<String> ordersRestaurant =
                              snapshot.data!['ordersRestaurant'] ?? [];
                          List<String> ordersSkooper =
                              snapshot.data!['ordersSkooper'] ?? [];

                          return Column(
                            children: [
                              ordersRestaurant.contains(widget.order['_id']) ==
                                      false
                                  ? getCtaButton(
                              ...
                              //     ? const SizedBox()
                              //     :
                              ordersSkooper.contains(widget.order is ActiveOrder
                                          ? widget.order.id
                                          : widget.order['_id']) ==
                                      false
                                  ? getCtaButton(
  ...
  Future<void> addSkooperReview({
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      ...
      if (response.statusCode == 201) {
        ...
        SharedPreferences sp = await SharedPreferences.getInstance();
        ordersSkooper.add(widget.order['_id']);
        sp
            .setStringList('ordersListSkooper', ordersSkooper)
  ...
  Future<void> addReviewRestaurant({
    ...
    if (response.statusCode == 204) {
      ...
      SharedPreferences sp = await SharedPreferences.getInstance();
      ordersRestaurant.add(
          widget.order is ActiveOrder ? widget.order.id : widget.order['_id']);
      sp.setStringList('ordersListRestaurant', ordersRestaurant);
